...
function placeXOrO(squareNumber) {
    ...
    if (!selectSquares.some(element => element.includes(squareNumber))){
        ...
        if(activePlayer==='X') {
            ...
            //Active player may only be 'X' or 'O'so, if not 'X' it must ne 'O'
    
        } else {
            //If activPlayer is equal to 'O', the o.png is placed in HTML
...
function checkWinConditions() {
    ...
    //X 6,7,8 condition.
     ...
     function arrayIncludes(squareA, squareB, squareC) {
        ...
        //If the 3 variables we pass are all includes in our array then
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    //This line indicates where the start of a line x axis is.
    y2 = coordY2,
    //This variable stores temporary x axis data update in our animation loop
    x = x1,
    //This variable stores temporary y axis data update in our animation loop
    y = y1
    ...
    function animateLineDrawing() {
        ...
        c.stroke();
        //This condition checks if we've reached the endpointd.
        if (x1 <= x2 && y1 <=y2) {
    ...
    animateLineDrawing();
    //This line waits 1 second. Then, clears canvas, reset game, an allows clicking again.
